...
public final class AppUtils {
    ...
    public static String getGoodsDecimal(String goods){
        String valueStr = "%.2f";
        if (ConstantUtil.USDOLLARINDEX.equals(goods)) {
            valueStr = "%.4f";
        } else if (ConstantUtil.XAGUSD.equals(goods)) {
            valueStr = "%.3f";
        } else if (ConstantUtil.XAUUSD.equals(goods)) {
            valueStr = "%.2f";
        } else {
            valueStr = "%.2f";
        }
    ...
    public static void setTextViewColor(String str, int start,int end,TextView textView,int color){
        ...
        sbuilder.setSpan(yellowSpan, 2,str.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    public static void setTextSize(String str,TextView textView){
        if (!TextUtils.isEmpty(str) && textView!=null){
            ...
            SpannableStringBuilder sbuilder = new SpannableStringBuilder(str);
            sbuilder.setSpan(new AbsoluteSizeSpan(21,true),startIndex,str.length(),Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            textView.setText(sbuilder);
        }
    }
    ...
    public static void  setCustomFont(Context context, TextView textView) {
        ...
        Typeface fromAsset = Typeface.createFromAsset(assets, "fonts/monofonto.ttf");
        if (textView!=null){
