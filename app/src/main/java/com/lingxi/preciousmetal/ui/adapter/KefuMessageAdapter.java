...
import com.lingxi.preciousmetal.ui.widget.kefu.ChatRowText;
...
public class KefuMessageAdapter extends BaseAdapter {
	...
	private static class WeakHandler extends android.os.Handler {
		WeakReference<KefuMessageAdapter> weakReference;

		public WeakHandler(KefuMessageAdapter adapter) {
			this.weakReference = new WeakReference<KefuMessageAdapter>(adapter);
		}

		private void refreshList() {
			KefuMessageAdapter messageAdapter = weakReference.get();
	...
	public KefuMessageAdapter(Context context, String username, ListView listView) {
	...
	protected ChatRow createChatRow(Context context, Message message, int position) {
        ...
        case FILE:
            ...
            break;
        case IMAGE:
            chatRow = new com.lingxi.preciousmetal.ui.widget.kefu.ChatRowImage(context, message, position, this);
            break;
        case VOICE:
	...
	private KefuMessageAdapter.OnItemClickListener listener;

	public void setOnItemClickListener(KefuMessageAdapter.OnItemClickListener listener) {
