...
public class KefuEmoGridViewAdapter extends BaseAdapter {
    private List<String> lists;
    private Context context;
    private LayoutInflater inflater;

    public KefuEmoGridViewAdapter(List<String> lists, Context context) {
        this.lists = lists;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (iv_emo.getTag() == null) {
            int id = KefuFaceManager.getInstance().getFaceId(lists.get(position));
