...
//                applyAlphaAnimation(mTv, mAnimAlphaStart);
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                if (mCollapsed) {
                    mTv.setMaxLines(MAX_COLLAPSED_LINES);
                } else {
    ...
    public void setTextColor(@Nullable int textColor) {
    ...
    private void init(AttributeSet attrs) {
        ...
        typedArray.recycle();
        mExpandText = getResources().getString(R.string.commonui_expand);
        mCollapseText = getResources().getString(R.string.commonui_unexpand);
