...
public class CommonHeader extends InternalClassics<CommonHeader> implements RefreshHeader {

    public static final byte ID_TEXT_UPDATE = 4;
    public static String REFRESH_HEADER_PULLING = "让交易更简单";//"下拉可以刷新";
    public static String REFRESH_HEADER_REFRESHING = "刷新中";//"正在刷新...";
    public static String REFRESH_HEADER_LOADING = "松手更新";//"正在加载...";
    public static String REFRESH_HEADER_RELEASE = "下拉刷新";//"释放立即刷新";
    public static String REFRESH_HEADER_FINISH = "刷新完成";//"刷新完成";
    public static String REFRESH_HEADER_FAILED = "刷新失败";//"刷新失败";
    public static String REFRESH_HEADER_UPDATE = "更新于 %s";//"上次更新 M-d HH:mm";
...
//        mLastUpdateText.setTextColor(0xff7c7c7c);
        mLastUpdateFormat =  new DynamicTimeFormat(REFRESH_HEADER_UPDATE);

        final View thisView = this;
        final View arrowView = mArrowView;
        LayoutParams arrowViewParams = (LayoutParams) arrowView.getLayoutParams();
        arrowViewParams.width = arrowViewParams.width+ViewUtil.Dp2Px(context,10);
        arrowViewParams.height = arrowViewParams.height+ViewUtil.Dp2Px(context,10);
        ...
        mCenterLayout.setGravity(Gravity.NO_GRAVITY);
        ...
        lpProgress.rightMargin = 0;//ta.getDimensionPixelSize(com.scwang.smartrefresh.layout.R.styleable.ClassicsFooter_srlDrawableMarginRight, density.dip2px(20));
        ...
        if (ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.ClassicsHeader_srlDrawableArrow)) {
            ...
            GlideApp.with(getContext()).load(R.drawable.lx_head_icon).into(mArrowView);

//            mArrowView.setImageDrawable(AppCompatResources.getDrawable(getContext(), R.drawable.gif_like));
...
//            mArrowView.setImageDrawable(mArrowDrawable);
        ...
        //    GlideApp.with(getContext()).load(R.drawable.lx_head_icon).into(mProgressView);
...
//            mProgressView.setImageDrawable(mProgressDrawable);
        ...
        mTitleText.setTextColor(ContextCompat.getColor(context,R.color.ff33));
        mLastUpdateText.setTextColor(ContextCompat.getColor(context,R.color.ff33));
    ...
    public void onStateChanged(@NonNull RefreshLayout refreshLayout, @NonNull RefreshState oldState, @NonNull RefreshState newState) {
        ...
        switch (newState) {
            ...
            case PullDownToRefresh:
                mLastUpdateText.setText(REFRESH_HEADER_RELEASE);
                arrowView.setVisibility(VISIBLE);
//                arrowView.animate().rotation(0);
                break;
            case Refreshing:
            case RefreshReleased:
                mLastUpdateText.setText(REFRESH_HEADER_REFRESHING);
//                arrowView.setVisibility(GONE);
                break;
            case ReleaseToRefresh:
                mLastUpdateText.setText(REFRESH_HEADER_LOADING);
//                arrowView.animate().rotation(180);
                break;
            case ReleaseToTwoLevel:
                mLastUpdateText.setText(REFRESH_HEADER_SECONDARY);
//                arrowView.animate().rotation(0);
                break;
            case Loading:
//                arrowView.setVisibility(GONE);
    ...
    public CommonHeader setLastUpdateTime(Date time) {
        final View thisView = this;
        mLastTime = time;
    ...
    public CommonHeader setTimeFormat(DateFormat format) {
    ...
    public CommonHeader setLastUpdateText(CharSequence text) {
        mLastTime = null;
        mLastUpdateText.setText(text);
        return this;
    }

//    public CommonHeader setAccentColor(@ColorInt int accentColor) {
//        mLastUpdateText.setTextColor(accentColor&0x00ffffff|0xcc000000);
//        return super.setAccentColor(accentColor);
//    }

    public CommonHeader setEnableLastTime(boolean enable) {
        final View updateView = mLastUpdateText;
...
//            mRefreshKernel.requestRemeasureHeightForHeader();
    ...
    public CommonHeader setTextSizeTime(float size) {
...
//    public CommonHeader setTextSizeTime(int unit, float size) {
...
//    }
    ...
    public CommonHeader setTextTimeMarginTop(float dp) {
        final View updateView = mLastUpdateText;
