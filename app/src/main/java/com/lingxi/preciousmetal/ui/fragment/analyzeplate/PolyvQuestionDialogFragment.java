...
public class PolyvQuestionDialogFragment extends BaseDialogFragment implements View.OnClickListener {
...
//     * @param chatUserId  登录聊天室的学员id(注：相同chatUserId之间不会收到对方的信息)
     ...
     */
    public void initChatConfig(@NonNull MyPolyvChatManager chatManager, NewsFrPagerAdapter pager, String userId, String channelId, String nick_name) {
...
//        polyvChatAdapter.setViewPagerFragment(viewPagerFragment);
    ...
    private void sendMsg() {
        ...
        final PolyvChatFragment chatFragment = (PolyvChatFragment) pager.getItem(1);
        List<String> badwords = chatFragment.getBadwords();
