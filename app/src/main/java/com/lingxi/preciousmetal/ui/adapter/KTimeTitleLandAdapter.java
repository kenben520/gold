...
public class KTimeTitleLandAdapter extends CommonAdapter<TimeTitleBean> {

    public KTimeTitleLandAdapter(Context context, List<TimeTitleBean> datas, int itemLayoutResId) {
