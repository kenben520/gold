...
public class CustomCircleProgressBar extends View {
    ...
    public CustomCircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        outsideRadius = a.getDimension(R.styleable.CustomCircleProgressBar_outside_radius, ViewUtil.Dp2Px(getContext(), 60.0f));
        insideColor = a.getColor(R.styleable.CustomCircleProgressBar_inside_color, ContextCompat.getColor(getContext(), R.color.colorPrimary));
        ...
        progressTextSize = a.getDimension(R.styleable.CustomCircleProgressBar_progress_text_size,  ViewUtil.Dp2Px(getContext(), 14.0f));
        progressWidth = a.getDimension(R.styleable.CustomCircleProgressBar_progress_width,  ViewUtil.Dp2Px(getContext(), 10.0f));
        ...
        name = a.getString(R.styleable.CustomCircleProgressBar_name);
        a.recycle();
        paint = new Paint();
    }
