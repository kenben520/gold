 ...
 */
public class PolyvPlayerAuxiliaryView1 extends RelativeLayout {
...
//	private PolyvPlayerDanmuFragment danmuFragment = null;
    ...
    public PolyvPlayerAuxiliaryView1(Context context) {
        this(context, null);
    }

    public PolyvPlayerAuxiliaryView1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PolyvPlayerAuxiliaryView1(Context context, AttributeSet attrs, int defStyle) {
