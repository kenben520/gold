...
public class Banner extends FrameLayout implements OnPageChangeListener {
    public String tag = "lx_banner_layout";
    ...
    private int mLayoutResId = R.layout.lx_banner_layout;
    ...
    private LinearLayout indicator, myIndicator,indicatorInside, titleView;
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.lx_banner, this, true);
        ...
        myIndicator= (LinearLayout) view.findViewById(R.id.myIndicator);
    ...
    private void createIndicator() {
       ...
       // indicator.setPadding(0,0,0,50);
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (bannerStyle == BannerConfig.CIRCLE_INDICATOR ||
                    bannerStyle == BannerConfig.CIRCLE_INDICATOR_TITLE)
                myIndicator.addView(imageView, params);
