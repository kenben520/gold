...
public class RecyclerViewDivider extends RecyclerView.ItemDecoration {
    ...
    public RecyclerViewDivider(Context context) {
        ...
        mDividerHeight = ViewUtil.Dp2Px(context,0.5f);
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(ContextCompat.getColor(context,R.color.line));
    ...
    public RecyclerViewDivider(Context context, int orientation, float dividerHeight, int dividerColor) {
        this(context, orientation);
        mDividerHeight = ViewUtil.Dp2Px(context,dividerHeight);
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
