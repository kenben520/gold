package com.lingxi.preciousmetal.ui.widget.kefu;
...
public class ChatRowImage extends ChatRowFile{
    ...
    protected void onInflatView() {
        inflater.inflate(message.direct() == Message.Direct.RECEIVE ? R.layout.kefu_received_picture : R.layout.kefu_sent_picture, this);
    }
    ...
    protected void onSetUpView() {
        ...
        if (message.direct() == Message.Direct.RECEIVE) {
            if (imgBody.thumbnailDownloadStatus() == EMFileMessageBody.EMDownloadStatus.DOWNLOADING ||
                ...
                GlideUtils.loadImageViewError(context, "", imageView, R.drawable.hd_default_image);
...
//                imageView.setImageResource(R.drawable.hd_default_image);
                ...
                GlideUtils.loadImageViewError(context, thumbPath, imageView, R.drawable.hd_default_image);
//                showImageView(thumbPath, imageView, imgBody.getLocalUrl(), message);
            }
            return;
        }
        GlideUtils.loadImageViewError(context, imgBody.getLocalUrl(), imageView, R.drawable.hd_default_image);
