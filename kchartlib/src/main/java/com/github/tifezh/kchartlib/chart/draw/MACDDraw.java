...
public class MACDDraw implements IChartDraw<IMACD> {
    ...
    public MACDDraw(BaseKChartView view) {
        ...
        mRedPaint.setColor(ViewUtil.getKLossColor(context));
        mGreenPaint.setColor(ViewUtil.getKUpColor(context));
    }
    ...
    public void drawText(@NonNull Canvas canvas, @NonNull BaseKChartView view, int position, float x, float y) {
        ...
        text = "DIFF:" + view.formatValue(point.getDif()) + " ";
        ...
        canvas.drawText(text, left, y, mMACDPaint);
    }
