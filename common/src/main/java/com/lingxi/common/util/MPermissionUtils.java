...
//        final MonkeyTwoBtnDialog monkeyTwoBtnDialog = new MonkeyTwoBtnDialog(context);
//        monkeyTwoBtnDialog.setOnDialogItemClickListener(new BaseDialog.OnDialogItemClickListener() {
//            @Override
//            public void onDiaogItemClick(int position) {
//                if (position == 1) {
//                    monkeyTwoBtnDialog.dismiss();
...
//            }
//        });
//        monkeyTwoBtnDialog.bindDataAndShow(-1, "权限申请", "当前应用缺少必要权限，该功能暂时无法使用。如若需要，请单击【去申请】按钮前往设置中心进行权限授权。", "拒绝", "去申请");
    }
